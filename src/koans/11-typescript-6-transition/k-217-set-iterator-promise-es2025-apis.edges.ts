...
type _09 = Expect<Equal<Exclude<Scenario, "Set.union">, TODO>>; // TODO(koan) @koan-error
type _10 = Expect<Equal<Exclude<Scenario, "Promise.try">, TODO>>; // TODO(koan) @koan-error
...
type _22 = Expect<Equal<Extract<Rule, { scenario: "Set.union" }>, TODO>>; // TODO(koan) @koan-error
type _23 = Expect<Equal<Exclude<Rule, { scenario: "Set.union" }>, TODO>>; // TODO(koan) @koan-error
type _24 = Expect<Equal<OutcomeFor<"Set.union">, TODO>>; // TODO(koan) @koan-error
type _25 = Expect<Equal<OutcomeFor<"Promise.try">, TODO>>; // TODO(koan) @koan-error
