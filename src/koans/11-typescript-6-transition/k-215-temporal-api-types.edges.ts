...
type _09 = Expect<Equal<Exclude<Scenario, "Instant">, TODO>>; // TODO(koan) @koan-error
type _10 = Expect<Equal<Exclude<Scenario, "Now">, TODO>>; // TODO(koan) @koan-error
...
type _22 = Expect<Equal<Extract<Rule, { scenario: "Instant" }>, TODO>>; // TODO(koan) @koan-error
type _23 = Expect<Equal<Exclude<Rule, { scenario: "Instant" }>, TODO>>; // TODO(koan) @koan-error
type _24 = Expect<Equal<OutcomeFor<"Instant">, TODO>>; // TODO(koan) @koan-error
type _25 = Expect<Equal<OutcomeFor<"Now">, TODO>>; // TODO(koan) @koan-error
