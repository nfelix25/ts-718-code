...
type _08 = Expect<Equal<Exclude<Scenario, "moduleResolution-node10">, TODO>>; // TODO(koan) @koan-error
type _09 = Expect<Equal<Exclude<Scenario, "outFile">, TODO>>; // TODO(koan) @koan-error
...
type _21 = Expect<Equal<Extract<Rule, { scenario: "moduleResolution-node10" }>, TODO>>; // TODO(koan) @koan-error
type _22 = Expect<Equal<Exclude<Rule, { scenario: "moduleResolution-node10" }>, TODO>>; // TODO(koan) @koan-error
type _23 = Expect<Equal<OutcomeFor<"moduleResolution-node10">, TODO>>; // TODO(koan) @koan-error
type _24 = Expect<Equal<OutcomeFor<"outFile">, TODO>>; // TODO(koan) @koan-error
