...
type _07 = Expect<Equal<Exclude<Scenario, "dom">, TODO>>; // TODO(koan) @koan-error
type _08 = Expect<Equal<Exclude<Scenario, "runtime">, TODO>>; // TODO(koan) @koan-error
...
type _20 = Expect<Equal<Extract<Rule, { scenario: "dom" }>, TODO>>; // TODO(koan) @koan-error
type _21 = Expect<Equal<Exclude<Rule, { scenario: "dom" }>, TODO>>; // TODO(koan) @koan-error
type _22 = Expect<Equal<OutcomeFor<"dom">, TODO>>; // TODO(koan) @koan-error
type _23 = Expect<Equal<OutcomeFor<"runtime">, TODO>>; // TODO(koan) @koan-error
