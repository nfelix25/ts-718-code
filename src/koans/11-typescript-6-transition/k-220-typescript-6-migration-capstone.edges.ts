...
type _08 = Expect<Equal<Exclude<Scenario, "pin-defaults">, TODO>>; // TODO(koan) @koan-error
type _09 = Expect<Equal<Exclude<Scenario, "dual-compiler">, TODO>>; // TODO(koan) @koan-error
...
type _21 = Expect<Equal<Extract<Rule, { scenario: "pin-defaults" }>, TODO>>; // TODO(koan) @koan-error
type _22 = Expect<Equal<Exclude<Rule, { scenario: "pin-defaults" }>, TODO>>; // TODO(koan) @koan-error
type _23 = Expect<Equal<OutcomeFor<"pin-defaults">, TODO>>; // TODO(koan) @koan-error
type _24 = Expect<Equal<OutcomeFor<"dual-compiler">, TODO>>; // TODO(koan) @koan-error
