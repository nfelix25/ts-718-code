...
type _07 = Expect<Equal<Exclude<Scenario, "exactOptionalPropertyTypes">, TODO>>; // TODO(koan) @koan-error
type _08 = Expect<Equal<Exclude<Scenario, "noUncheckedSideEffectImports">, TODO>>; // TODO(koan) @koan-error
...
type _20 = Expect<Equal<Extract<Rule, { scenario: "exactOptionalPropertyTypes" }>, TODO>>; // TODO(koan) @koan-error
type _21 = Expect<Equal<Exclude<Rule, { scenario: "exactOptionalPropertyTypes" }>, TODO>>; // TODO(koan) @koan-error
type _22 = Expect<Equal<OutcomeFor<"exactOptionalPropertyTypes">, TODO>>; // TODO(koan) @koan-error
type _23 = Expect<Equal<OutcomeFor<"noUncheckedSideEffectImports">, TODO>>; // TODO(koan) @koan-error
