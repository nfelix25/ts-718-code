...
type _08 = Expect<Equal<Exclude<Scenario, "getOrInsert-hit">, TODO>>; // TODO(koan) @koan-error
type _09 = Expect<Equal<Exclude<Scenario, "concurrency">, TODO>>; // TODO(koan) @koan-error
...
type _21 = Expect<Equal<Extract<Rule, { scenario: "getOrInsert-hit" }>, TODO>>; // TODO(koan) @koan-error
type _22 = Expect<Equal<Exclude<Rule, { scenario: "getOrInsert-hit" }>, TODO>>; // TODO(koan) @koan-error
type _23 = Expect<Equal<OutcomeFor<"getOrInsert-hit">, TODO>>; // TODO(koan) @koan-error
type _24 = Expect<Equal<OutcomeFor<"concurrency">, TODO>>; // TODO(koan) @koan-error
