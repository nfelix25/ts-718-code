...
type _07 = Expect<Equal<Exclude<Scenario, "legacy-order">, TODO>>; // TODO(koan) @koan-error
type _08 = Expect<Equal<Exclude<Scenario, "long-term-config">, TODO>>; // TODO(koan) @koan-error
...
type _20 = Expect<Equal<Extract<Rule, { scenario: "legacy-order" }>, TODO>>; // TODO(koan) @koan-error
type _21 = Expect<Equal<Exclude<Rule, { scenario: "legacy-order" }>, TODO>>; // TODO(koan) @koan-error
type _22 = Expect<Equal<OutcomeFor<"legacy-order">, TODO>>; // TODO(koan) @koan-error
type _23 = Expect<Equal<OutcomeFor<"long-term-config">, TODO>>; // TODO(koan) @koan-error
