...
type _07 = Expect<Equal<Exclude<Scenario, "ts6-clean-stable">, TODO>>; // TODO(koan) @koan-error
type _08 = Expect<Equal<Exclude<Scenario, "compiler-api">, TODO>>; // TODO(koan) @koan-error
...
type _20 = Expect<Equal<Extract<Rule, { scenario: "ts6-clean-stable" }>, TODO>>; // TODO(koan) @koan-error
type _21 = Expect<Equal<Exclude<Rule, { scenario: "ts6-clean-stable" }>, TODO>>; // TODO(koan) @koan-error
type _22 = Expect<Equal<OutcomeFor<"ts6-clean-stable">, TODO>>; // TODO(koan) @koan-error
type _23 = Expect<Equal<OutcomeFor<"compiler-api">, TODO>>; // TODO(koan) @koan-error
