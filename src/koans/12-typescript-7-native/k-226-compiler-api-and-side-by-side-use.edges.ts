...
type _07 = Expect<Equal<Exclude<Scenario, "native-tsc">, TODO>>; // TODO(koan) @koan-error
type _08 = Expect<Equal<Exclude<Scenario, "future-api">, TODO>>; // TODO(koan) @koan-error
...
type _20 = Expect<Equal<Extract<Rule, { scenario: "native-tsc" }>, TODO>>; // TODO(koan) @koan-error
type _21 = Expect<Equal<Exclude<Rule, { scenario: "native-tsc" }>, TODO>>; // TODO(koan) @koan-error
type _22 = Expect<Equal<OutcomeFor<"native-tsc">, TODO>>; // TODO(koan) @koan-error
type _23 = Expect<Equal<OutcomeFor<"future-api">, TODO>>; // TODO(koan) @koan-error
