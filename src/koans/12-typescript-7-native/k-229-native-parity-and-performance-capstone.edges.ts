...
type _08 = Expect<Equal<Exclude<Scenario, "freeze-inputs">, TODO>>; // TODO(koan) @koan-error
type _09 = Expect<Equal<Exclude<Scenario, "tooling-gaps">, TODO>>; // TODO(koan) @koan-error
...
type _21 = Expect<Equal<Extract<Rule, { scenario: "freeze-inputs" }>, TODO>>; // TODO(koan) @koan-error
type _22 = Expect<Equal<Exclude<Rule, { scenario: "freeze-inputs" }>, TODO>>; // TODO(koan) @koan-error
type _23 = Expect<Equal<OutcomeFor<"freeze-inputs">, TODO>>; // TODO(koan) @koan-error
type _24 = Expect<Equal<OutcomeFor<"tooling-gaps">, TODO>>; // TODO(koan) @koan-error
