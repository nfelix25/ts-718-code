...
type _07 = Expect<Equal<Exclude<Scenario, "transport">, TODO>>; // TODO(koan) @koan-error
type _08 = Expect<Equal<Exclude<Scenario, "embedded-language">, TODO>>; // TODO(koan) @koan-error
...
type _20 = Expect<Equal<Extract<Rule, { scenario: "transport" }>, TODO>>; // TODO(koan) @koan-error
type _21 = Expect<Equal<Exclude<Rule, { scenario: "transport" }>, TODO>>; // TODO(koan) @koan-error
type _22 = Expect<Equal<OutcomeFor<"transport">, TODO>>; // TODO(koan) @koan-error
type _23 = Expect<Equal<OutcomeFor<"embedded-language">, TODO>>; // TODO(koan) @koan-error
