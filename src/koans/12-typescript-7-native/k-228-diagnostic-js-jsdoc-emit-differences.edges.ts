...
type _08 = Expect<Equal<Exclude<Scenario, "template-unicode">, TODO>>; // TODO(koan) @koan-error
type _09 = Expect<Equal<Exclude<Scenario, "declaration-diagnostic">, TODO>>; // TODO(koan) @koan-error
...
type _21 = Expect<Equal<Extract<Rule, { scenario: "template-unicode" }>, TODO>>; // TODO(koan) @koan-error
type _22 = Expect<Equal<Exclude<Rule, { scenario: "template-unicode" }>, TODO>>; // TODO(koan) @koan-error
type _23 = Expect<Equal<OutcomeFor<"template-unicode">, TODO>>; // TODO(koan) @koan-error
type _24 = Expect<Equal<OutcomeFor<"declaration-diagnostic">, TODO>>; // TODO(koan) @koan-error
