...
type _07 = Expect<Equal<Exclude<Scenario, "target-es5">, TODO>>; // TODO(koan) @koan-error
type _08 = Expect<Equal<Exclude<Scenario, "legacy-syntax">, TODO>>; // TODO(koan) @koan-error
...
type _20 = Expect<Equal<Extract<Rule, { scenario: "target-es5" }>, TODO>>; // TODO(koan) @koan-error
type _21 = Expect<Equal<Exclude<Rule, { scenario: "target-es5" }>, TODO>>; // TODO(koan) @koan-error
type _22 = Expect<Equal<OutcomeFor<"target-es5">, TODO>>; // TODO(koan) @koan-error
type _23 = Expect<Equal<OutcomeFor<"legacy-syntax">, TODO>>; // TODO(koan) @koan-error
