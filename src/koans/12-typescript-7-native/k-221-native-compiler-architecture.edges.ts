...
type _08 = Expect<Equal<Exclude<Scenario, "implementation-language">, TODO>>; // TODO(koan) @koan-error
type _09 = Expect<Equal<Exclude<Scenario, "memory">, TODO>>; // TODO(koan) @koan-error
...
type _21 = Expect<Equal<Extract<Rule, { scenario: "implementation-language" }>, TODO>>; // TODO(koan) @koan-error
type _22 = Expect<Equal<Exclude<Rule, { scenario: "implementation-language" }>, TODO>>; // TODO(koan) @koan-error
type _23 = Expect<Equal<OutcomeFor<"implementation-language">, TODO>>; // TODO(koan) @koan-error
type _24 = Expect<Equal<OutcomeFor<"memory">, TODO>>; // TODO(koan) @koan-error
